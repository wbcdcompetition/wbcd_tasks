...
|---|---|---:|---:|---|
| <img src="media/Storage_container.png" height="80"> | Storage container A | 1 | - | [Taobao CN: 【淘宝】7天无理由退货 https://e.tb.cn/h.ieUyK7o06MDAIoT?tk=s2RjUwfJokB HU071 「升级超硬特厚加高飞机盒高12cm长方形纸盒高11cm正方形礼品包装盒」点击链接直接打开 或者 淘宝搜索直接打开] |
| <img src="media/Storage_container.png" height="80"> | Storage container B | 1 | - | [Taobao CN:【淘宝】7天无理由退换 https://e.tb.cn/h.i3J0cP1R0GWqy0e?tk=bMpWUwfsZPd tG-#22>lD 「梦箱家搬家纸箱打包箱快递物流包装大箱子家用整理收纳箱加厚加硬」点击链接直接打开 或者 淘宝搜索直接打开] |
...
- **Autonomy multiplier:** For each **run**, base points earned in that run are multiplied by that run’s [autonomy level multiplier](../README.md#autonomy-level-multiplier) (×1 on-site teleop / ×2 remote teleop / ×4 fully autonomous). Here a **run** is one **item** taken through pick → scan → place (one pass through the three workflow steps). Teams declare one autonomy level per item/run, not per workflow step.
